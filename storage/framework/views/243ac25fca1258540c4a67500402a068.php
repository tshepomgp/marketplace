...
<?php $__env->startSection('title', 'Domain Available'); ?>
...
<div class="bg-green-50 border-2 border-green-500 rounded-lg p-8 text-center mb-8">
    ...
    <p class="text-3xl font-bold text-green-900 mb-2"><?php echo e($domain); ?></p>
    <p class="text-green-700 mb-6 text-lg">This domain is available for registration!</p>
    <p class="text-4xl font-bold text-green-600 mb-8"><?php echo e(number_format($price, 0)); ?> <?php echo e($currency); ?>/year</p>
    
    <!-- Pass plan_id in URL query string -->
    
    <a href="<?php echo e(route('customer.email-hosting.checkout', ['domain' => $domain, 'plan_id' => $planId])); ?>" 
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TMOKK5\Projects\microsoft-marketplace\resources\views/customer/email-hosting/domain-available.blade.php ENDPATH**/ ?>