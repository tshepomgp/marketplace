...
<div class="bg-green-50 border-l-4 border-green-600 p-6 rounded-lg mb-8">
    ...
    <p class="text-green-800 text-sm mt-2">A confirmation email with all your credentials has been sent to <?php echo e(Auth::user()->email); ?></p>
</div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="space-y-4">
            <div>
                ...
                <p class="text-lg font-bold text-mtn-black">#<?php echo e($order->order_number); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Domain</p>
                <p class="text-lg font-bold text-mtn-black"><?php echo e($order->domain->domain_name); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Hosting Plan</p>
                <p class="text-lg font-bold text-mtn-black"><?php echo e($order->emailHostingPlan->name); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Total Amount</p>
                <p class="text-2xl font-bold text-mtn-yellow"><?php echo e(number_format($order->total_amount, 0)); ?> XAF</p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Order Date</p>
                <p class="text-lg font-semibold"><?php echo e($order->created_at->format('F d, Y H:i')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-lg font-semibold"><?php echo e($order->domain->registered_date->format('F d, Y')); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Expiration Date</p>
                <p class="text-lg font-semibold"><?php echo e($order->domain->expiration_date->format('F d, Y')); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Auto Renewal</p>
                <p class="text-lg font-semibold"><?php echo e($order->domain->auto_renew ? '✅ Enabled' : '❌ Disabled'); ?></p>
            </div>
            
            <div>
                <p class="text-gray-600 text-sm">Registrar</p>
                <p class="text-lg font-semibold"><?php echo e(ucfirst($order->domain->registrar)); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-lg p-8 mb-8">
    ...
    <?php if($emailAccounts->count() > 0): ?>
        <div class="space-y-6">
            <?php $__currentLoopData = $emailAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border-2 border-gray-300 rounded-lg p-6">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h3 class="text-lg font-bold text-mtn-black"><?php echo e($account->email_address); ?></h3>
                        <p class="text-sm text-gray-600">Mailbox <?php echo e($index + 1); ?> of <?php echo e($emailAccounts->count()); ?></p>
                    </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p class="font-mono bg-white p-2 rounded border border-gray-300"><?php echo e($account->imap_host); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600">IMAP Port</p>
                            <p class="font-mono bg-white p-2 rounded border border-gray-300"><?php echo e($account->imap_port); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600">SMTP Server</p>
                            <p class="font-mono bg-white p-2 rounded border border-gray-300"><?php echo e($account->smtp_host); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600">SMTP Port</p>
                            <p class="font-mono bg-white p-2 rounded border border-gray-300"><?php echo e($account->smtp_port); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-4 space-y-4 bg-gray-50 p-4 rounded-lg">
                        <div>
                            ...
                            <ol class="list-decimal list-inside text-sm text-gray-700 space-y-1">
                                ...
                                <li>Enter your email address: <?php echo e($account->email_address); ?></li>
                                <li>Enter password</li>
                                <li>Select "IMAP" protocol</li>
                                <li>Server: <?php echo e($account->imap_host); ?>, Port: <?php echo e($account->imap_port); ?>, SSL: Yes</li>
                                <li>Outgoing Server: <?php echo e($account->smtp_host); ?>, Port: <?php echo e($account->smtp_port); ?>, TLS: Yes</li>
                            </ol>
                        </div>
                        ...
                        <div>
                            ...
                            <ol class="list-decimal list-inside text-sm text-gray-700 space-y-1">
                                ...
                                <li>Incoming Server: <?php echo e($account->imap_host); ?></li>
                                <li>Outgoing Server: <?php echo e($account->smtp_host); ?></li>
                            </ol>
                        </div>
                        ...
                        <div>
                            ...
                            <ol class="list-decimal list-inside text-sm text-gray-700 space-y-1">
                                <li>Visit your webmail at: <strong>https://mail.<?php echo e($order->domain->domain_name); ?></strong></li>
                                <li>Username: <?php echo e($account->mailbox_name); ?></li>
                        ...
                        <div>
                            ...
                            <ol class="list-decimal list-inside text-sm text-gray-700 space-y-1">
                                ...
                                <li>Email address: <?php echo e($account->email_address); ?></li>
                ...
                <div class="bg-blue-50 p-4 rounded-lg text-sm text-blue-900">
                    <p><strong>Storage:</strong> <?php echo e($account->storage_gb); ?> GB available</p>
...
<!-- Action Buttons -->
<div class="space-y-3">
    <a href="<?php echo e(route('customer.email-hosting.my-domains')); ?>" class="block w-full text-center bg-mtn-yellow text-black py-4 rounded-lg font-bold hover:bg-mtn-orange transition">
        View All My Domains
    </a>
    <a href="<?php echo e(route('customer.dashboard')); ?>" class="block w-full text-center bg-gray-300 text-black py-4 rounded-lg font-bold hover:bg-gray-400 transition">
        Back to Dashboard
    </a>
</div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TMOKK5\Projects\microsoft-marketplace\resources\views/customer/email-hosting/success.blade.php ENDPATH**/ ?>