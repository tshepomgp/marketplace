    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-green-600 text-sm mt-2"><?php echo e($stats['active_products']); ?> active</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['total_revenue'], 0)); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['active_subscriptions']); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="<?php echo e(route('admin.products.create')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
               ...
               <a href="<?php echo e(route('admin.vm-skus.create')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center space-x-4">
                    <div class="bg-mtn-yellow rounded-full p-3">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-100 rounded-full p-3">
            ...
            <a href="<?php echo e(route('admin.customers.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center space-x-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TMOKK5\Projects\microsoft-marketplace\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>