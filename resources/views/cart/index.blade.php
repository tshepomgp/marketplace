        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-6 text-right text-gray-900 font-semibold">
                                    ...
                                    <span class="text-xs text-gray-500">{{ $item['currency'] ?? 'XAF' }}</span>
                                </td>
                                <td class="px-6 py-6 text-right">
                                    <p class="text-lg font-bold text-mtn-yellow">
                                        {{ number_format($itemTotal, 0) }}
                                    </p>
                                    <p class="text-xs text-gray-500">{{ $item['currency'] ?? 'XAF' }}</p>
                                </td>
                                <td class="px-6 py-6 text-center">
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    <a href="{{ route('customer.products.licence-ordering') }}" class="inline-flex items-center text-mtn-yellow hover:text-mtn-orange font-semibold transition">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-lg p-8 sticky top-24">
                ...
                <div class="flex justify-between mb-4">
                    <span class="text-gray-700">Items (<span class="font-semibold">{{ count($cart) }}</span>):</span>
                </div>
                ...
                <div class="flex justify-between mb-8">
                    ...
                    <span class="text-3xl font-bold text-mtn-yellow">{{ number_format($total, 0) }} XAF</span>
                </div>
                
                <!-- Checkout Button -->
                <a href="{{ route('checkout.index') }}" class="block w-full bg-mtn-yellow text-black text-center py-4 rounded-lg font-bold text-lg hover:bg-mtn-orange transition mb-3">
                    Proceed to Checkout
                </a>
                
                <!-- Continue Shopping Button -->
                <a href="{{ route('customer.products.licence-ordering') }}" class="block w-full bg-gray-300 text-black text-center py-3 rounded-lg font-semibold hover:bg-gray-400 transition">
                    Continue Shopping
                </a>
...
@else
    ...
    <div class="bg-white rounded-lg shadow-lg p-20 text-center">
        ...
        <a href="{{ route('customer.products.licence-ordering') }}" class="inline-block bg-mtn-yellow text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-mtn-orange transition">
            Start Shopping
        </a>
    </div>
@endif
