    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between pb-3 border-b">
                    ...
                    <span class="font-bold text-mtn-yellow">{{ $order->order_number }}</span>
                </div>
                
                <div class="flex justify-between pb-3 border-b">
                    <span class="text-gray-600">Plan:</span>
                    <span class="font-semibold capitalize">{{ str_replace('_', ' ', $order->storage_type) }}</span>
                </div>
                
                <div class="flex justify-between pb-3 border-b">
                    <span class="text-gray-600">Storage Size:</span>
                    <span class="font-semibold">{{ $order->storage_size }} TB</span>
                </div>
                
                <div class="flex justify-between pb-3 border-b">
                    <span class="text-gray-600">Monthly Cost:</span>
                    <span class="font-bold text-lg">{{ number_format($order->monthly_cost, 0) }} XAF</span>
                </div>
                
                <div class="flex justify-between">
                    <span class="text-gray-600">Renewal Date:</span>
                    <span class="font-semibold">  {{ optional($order->renewal_date)->format('M d, Y') ?? 'N/A' }}</span>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
            ...
            <div class="bg-white rounded p-3 text-sm">
                ...
                <p class="font-mono text-mtn-yellow">{{ $order->access_endpoint }}</p>
