...
<div class="mb-12">
    ...
    @if($plans->count() > 0)
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition transform hover:-translate-y-2 {{ $plan->name === 'Professional' ? 'border-4 border-mtn-yellow' : '' }}">
                <!-- Header -->
                ...
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        <p class="text-4xl font-bold text-mtn-yellow">{{ number_format($plan->price_per_mailbox, 0) }}<span class="text-lg"> XAF</span></p>
                    </div>

                    <div class="mb-6 pb-6 border-b-2 border-gray-200">
                        <p class="text-gray-600 text-sm">Domain Registration (1st Year)</p>
                        <p class="text-2xl font-bold text-mtn-black">{{ number_format($plan->domain_price, 0) }} XAF</p>
                    </div>
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-center text-gray-700">
                                ...
                                {{ $plan->mailboxes_included }} Mailbox(es)
                            </li>
                            @php
                    ...
                    <!-- CTA Button -->
                    <a href="{{ route('customer.email-hosting.domain-search', ['plan_id' => $plan->id]) }}" 
