...
<head>
    ...
    <title>@yield('title', 'MTN Microsoft License Marketplace')</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('customer.dashboard') }}" class="hover:text-mtn-yellow transition">
                        Dashboard
                    </a>
                    <a href="{{ route('customer.products.vm-ordering') }}" class="hover:text-mtn-yellow transition">
                        VM Licenses
                    </a>
                    <a href="{{ route('customer.products.storage-ordering') }}" class="hover:text-mtn-yellow transition">
                        Cloud Storage
                    </a>
    ...
    @auth
    <!-- Credit Indicator -->
    <a href="{{ route('customer.credit.dashboard') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg bg-yellow-50 hover:bg-yellow-100 transition">
        ...
        <div class="text-sm">
            ...
            <p class="font-bold text-mtn-yellow">{{ number_format(Auth::user()->getAvailableCredit(), 0) }} XAF</p>
        </div>
    </a>
    @endauth
</div>
