...
<head>
    ...
    <title>@yield('title', 'Admin - MTN Microsoft License Marketplace')</title>
...
<body class="bg-gray-100">
        ...
        <aside class="sidebar bg-mtn-black text-white shadow-lg fixed left-0 top-0 bottom-0 overflow-y-auto">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.dashboard') ?? '#' }}" 
                   class="block px-4 py-3 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'sidebar-active' : 'hover:bg-gray-800' }} transition">
                    <div class="flex items-center space-x-3">
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.products.index') }}" 
                       class="block px-4 py-3 rounded-lg {{ request()->routeIs('admin.products.*') ? 'sidebar-active' : 'hover:bg-gray-800' }} transition">
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.orders.vm') }}" 
                       class="block px-4 py-3 rounded-lg {{ request()->routeIs('admin.orders.vm') ? 'sidebar-active' : 'hover:bg-gray-800' }} transition">
                        <div class="flex items-center space-x-3 ml-4">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="{{ route('admin.email-hosting.orders') }}" class="flex items-center space-x-3 ml-4 hover:text-mtn-yellow transition">
    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM15 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2h-2zM5 13a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM15 13a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2h-2z"/>
    </svg>
    <span>Email Orders</span>
                    ...
                    <a href="{{ route('admin.orders.storage') }}" 
                       class="block px-4 py-3 rounded-lg {{ request()->routeIs('admin.orders.storage') ? 'sidebar-active' : 'hover:bg-gray-800' }} transition">
                        <div class="flex items-center space-x-3 ml-4">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex-1 ml-0 lg:ml-0" style="margin-left: 250px;">
            ...
            <nav class="bg-white shadow-sm sticky top-0 z-40">
                <div class="px-6 py-4 flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-mtn-black">@yield('page_title', 'Dashboard')</h1>
                    </div>
